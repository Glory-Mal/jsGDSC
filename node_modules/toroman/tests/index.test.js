...
describe("isRoman", () => {
    ...
    test("should throw error on invalid input", () => {
        try {
            ...
            // @ts-ignore
            expect(error.message).toBe("I cannot appear more than 3 times in a value");
        }
        try {
    ...
    test("should throw an error if L is followed by M", () => {
        try {
            ...
            // @ts-ignore
            expect(error.message).toBe("Unexpected token D, expected either X, V or I");
        }
    });
...
describe("toRoman", () => {
    ...
    test.each(testCases)("should return %s when called with %s", (expected, input) => {
...
describe("fromRoman", () => {
    ...
    test.each(testCases)("should return %s when called with %s is entered", (expected, input) => {
